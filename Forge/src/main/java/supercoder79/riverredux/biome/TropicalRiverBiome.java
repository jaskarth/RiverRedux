...
public class TropicalRiverBiome {
    public static Biome create() {
        MobSpawnSettings.Builder spawnSettings = new MobSpawnSettings.Builder()
                ...
                .addSpawn(MobCategory.WATER_AMBIENT, new MobSpawnSettings.SpawnerData(EntityType.TROPICAL_FISH, 30, 6, 12))
        ...
        BiomeGenerationSettings.Builder generationSettings = new BiomeGenerationSettings.Builder();//.surfaceBuilder(ConfiguredSurfaceBuilders.DESERT);
