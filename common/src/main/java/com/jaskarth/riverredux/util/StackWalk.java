package com.jaskarth.riverredux.util;
...
public final class StackWalk {
    ...
    public static boolean isVanillaInvocOfOBB() {
        ...
        for (int i = 0; i < traces.length; i++) {
            ...
            if (t.getClassName().equals("net.minecraft.server.Bootstrap")) {
//                System.out.println("Found bootstrap!!");
                return false;
            }
        }
...
//                System.out.println("Invalid class in stack: " + t.getClassName());
    ...
    private static boolean isValidPackage(String classname) {
        return classname.startsWith("java.") || classname.startsWith("com.jaskarth.") || classname.startsWith("net.minecraft.") || classname.startsWith("terrablender.");
    }
}
