...
public class RiverBiomes {
    ...
    public static final RegistryKey<Biome> SANDY = RegistryKey.of(RegistryKeys.BIOME, new Identifier("riverredux", "sandy_river"));
    public static final RegistryKey<Biome> GRAVELLY = RegistryKey.of(RegistryKeys.BIOME, new Identifier("riverredux", "gravelly_river"));
    public static final RegistryKey<Biome> TROPICAL = RegistryKey.of(RegistryKeys.BIOME, new Identifier("riverredux", "tropical_river"));
    public static final  RegistryKey<Biome> CARVED = RegistryKey.of(RegistryKeys.BIOME, new Identifier("riverredux", "carved_river"));
